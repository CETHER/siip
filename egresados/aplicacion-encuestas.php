  ...
  <tr height="100%" valign="top">
    <td>
      <table class="tablaInterior" border="0" cellspacing="4" cellpadding="0" align="center">
        ...
        <tr class="textoTitulos4">
	      ...
	      {
                printf( "<option value='aplicacion-encuestas.php?id_ciclo=%d' selected='selected'>%s</option>\n", $obj3->id_ciclo[$i], $obj3->nombre[$i] );
	      }
	      else
	      {
                printf( "<option value='aplicacion-encuestas.php?id_ciclo=%d'>%s</option>\n", $obj3->id_ciclo[$i], $obj3->nombre[$i] );
	      }
            }
	  ?>
          </select>
	...
	?>
        <tr class="textoTablas2">
          ...
          <td align="center">
          <a href="aplicacion-encuestas2.php?id_alumno=<?php echo $obj4->id_alumno[$i]; ?>">
